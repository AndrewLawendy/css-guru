...
const initialComputedValue: ComputedValueType = {
  alignContent: "normal",
  alignItems: "normal",
  alignSelf: "auto",
  ...
  webkitPerspectiveOrigin: "916px 0px",
  ...
  webkitTransformOrigin: "916px 0px",
...
export default function (): ComputedValueType {
